    ...
    return (
        <div className="min-h-screen w-full font-[Parkinsans] bg-[#F2F0EA] overflow-x-hidden">
            ...
            <div className="w-full my-[12vw] flex flex-col md:flex-row items-center justify-center gap-10 px-6">
                <div className="w-full md:w-[30%] h-auto md:h-64 bg-white shadow-md hover:shadow-xl hover:scale-[1.05] transition-transform p-6 rounded flex flex-col items-center text-center">
