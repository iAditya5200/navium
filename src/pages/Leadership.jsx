  ...
  return (
    <div className='min-h-screen  w-full font-[Parkinsans] bg-[#F2F0EA]  '>
      ...
      <div className='w-[90vw] mx-auto p-5 h-fit-content md:h-[45vh] my-10'>
        ...
        <h2 className='italic text-sm '>Director</h2>
        <p className='text-sm mt-3'>Specializing in Oil Tankers and Bulk Carriers, he has also expanded his proficiency to Gas Tankers, keeping pace with the maritime industry's direction toward cleaner fuels and sustainable operations. His leadership continues to inspire teams and elevate operational standards.  </p>
